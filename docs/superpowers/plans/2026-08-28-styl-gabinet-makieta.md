...
- [x] **Step 1: Podmień blok `:root` (linie 51-84)**
...
- [x] **Step 2: Podmień blok `.dark` (linie 86-118)**
...
- [x] **Step 1: Zamień import i deklarację fontu w `layout.tsx`**
...
- [x] **Step 2: Podłącz `--font-sans` w `globals.css`**
...
- [x] **Step 3: Sanity-check typów i builda**
...
- [x] **Step 4: Weryfikacja wizualna fontu**
...
- [x] **Step 1: Zamień `rounded-lg` na `rounded-full` w bazowej klasie**
...
- [x] **Step 2: Sanity-check typów i builda**
...
- [x] **Step 3: Weryfikacja wizualna przycisków**
...
- [x] **Step 1: Przejrzyj wizualnie każdą stronę w jasnym motywie**
...
- [x] **Step 2: Przejrzyj wizualnie ciemny motyw**
...
- [x] **Step 3: Napraw drobne odchylenia, jeśli się pojawią**
...
- [x] **Step 4: Finalny commit (jeśli step 3 nic nie zmienił, pomiń)**
